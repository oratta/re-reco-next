...
CREATE TABLE "new_JobReservationRate" (
    ...
    CONSTRAINT "JobReservationRate_castCode_fkey" FOREIGN KEY ("castCode") REFERENCES "Cast" ("code") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "JobReservationRate_groupCode_fkey" FOREIGN KEY ("groupCode") REFERENCES "Group" ("code") ON DELETE SET NULL ON UPDATE CASCADE,
