...
export default function JobListingSelect({ jobListings, onSubmit }) {
            ...
            <div>
                ...
                >
                    ...
                    {jobListings.slice(0, 5).map((jobListing) => (
                        <option key={jobListing.id} value={jobListing.id}>{jobListing.name || `Job Listing ${jobListing.id}`}</option>
                    ))}
                </select>
            </div>
